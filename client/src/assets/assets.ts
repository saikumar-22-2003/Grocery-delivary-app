...
export const appPromoBannerData = {
    ...
    description: "Download the FreshDrop app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
...
export const footerData = {
    ...
    contact: [
        { icon: MapPinIcon, text: "123 Near Green Valley road, Andhra Pradesh" },
        { icon: PhoneIcon, text: "+1 (111) 123-4567" },
        { icon: MailIcon, text: "hello@example.com" },
    ],

    bottom: {
        copyright: "© 2026 Saikumar. All rights reserved.",
        links: [
